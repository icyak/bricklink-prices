"""Simple script to get data from bricklink urls specified in list_of_urls.txt"""
...
FLISTOFSETS = 'list_of_urls_2.txt'
ZERO_ITEMS  = '0 Items'
XPATH_NAME  = '//*[@id="item-name-title"]/text()'
XPATH_ITEMS = '/html/body/div[3]/center/table/tbody/tr/td/section\
                /div/div/div[1]/div[3]/span[1]/span/text()'
